    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select name="gender" class="form-control">
                    ...
                    <option value="undefined" selected={{$user->gender==="undefined" ? 'selected' : ''}}>Тодорхойгүй
                    </option>
                    <select>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select name="user_type" class="form-control">
                    ...
                    <option value="operator" selected={{$user->user_type==="operator" ? 'selected' : ''}}>Оператор
                    </option>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="last_logined" value="{{ $user->last_logined }}" class="form-control"
                    placeholder="last_logined">
            </div>
        </div>
