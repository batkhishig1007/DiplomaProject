...
<body class="u-body">
    <header class="u-clearfix u-header u-section-row-container" id="sec-2f2a">
        <div class="u-section-rows">
            <div class="uk-container">
                <div class="u-clearfix u-section-row u-section-row-1" data-animation-name="" data-animation-duration="0"
                    data-animation-delay="0" data-animation-direction="" id="sec-344f">


                    <a href="/" class="u-image u-logo u-image-1" data-image-width="300" data-image-height="284">
                        <img src="{{URL::to('/images/khan-uula.png')}}" class="u-logo-image u-logo-image-1" />
                    </a>

                    <h4 class="u-text u-text-custom-color-2 u-text-default u-text-1">
                        &nbsp;<span class="u-text-custom-color-3">ХАН-УУЛ ДҮҮРЭГ</span>
                        &nbsp;<span class="u-text-black">2-Р ХОРОО</span>
                    </h4>

                </div>
            </div>
            <div class="u-gradient u-section-row u-sticky u-sticky-5b13 u-section-row-2" id="sec-5226">
                        ...
                        <div class="u-custom-menu u-nav-container">
                            <ul class="u-nav u-spacing-30 u-unstyled u-nav-1">
                                <li class="u-nav-item">
                                    <a class="
                                        u-border-2
                                        u-border-active-grey-90
                                        u-border-hover-grey-50
                                        u-border-no-left
                                        u-border-no-right
                                        u-border-no-top
                                        u-button-style
                                    ...
                                    " href="/" style="padding: 10px 34px">Үндсэн</a>
                                </li>
                                ...
                                <li class="u-nav-item">
                                    <a class="u-border-2 u-border-active-grey-90 u-border-hover-grey-50 u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90"
                                        style="padding: 10px 36px;" @guest href="{{route('login') }}" @else
                                        href="/admin/posts" @endguest>
                                        @guest
                                        Нэвтрэх
                                        @else
                                        @if($admin_type == 'admin')
                                        Админ
                                        @else($admin_type == 'operator')
                                        Оператор
                                        @endif
                                        @endguest
                                    </a>
                                ...
                                <div class="u-inner-container-layout u-sidenav-overflow">
                                    ...
                                    <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3">
                                        <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                href="/{{route('home')}}" style="padding: 10px 36px;">Үндсэн</a>
                                        </li>
                                        <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                href="{{route('taniltsuulga')}}"
                                                style="padding: 10px 36px;">Танилцуулга</a>
                                        </li>
                                        <li class="u-nav-item"><a class="u-button-style u-nav-link"
                                                href="/#carousel_bc4d" data-page-id="703620300"
                                                style="padding: 10px 36px;" href="{{ route('news_categories.index') }}">
                                                Мэдээлэл</a>
                                            <div class="u-nav-popup">
                                                <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10">
                                                    @foreach ($menu_categories as $row)
    ...
    <footer class="u-align-center u-clearfix u-footer u-gradient u-footer" id="sec-722b">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            <h1 class="u-text u-text-default u-text-1">Холбоо барих<br /></h1>
              ...
              ">
                ...
                ">
                            ...
                            <p class="u-text u-text-3">
                                Монгол улс, Улаанбаатар хот, Хан-Уул дүүрэг, 2-р хороо, "Иргэдэд үйлчлэх цогцолбор" байр
                            </p>
            ...
            <h2 class="u-text u-text-default u-text-8">
                © 2021 ЗОХИОГЧИЙН ЭРХ ХУУЛИАР ХАМГААЛАГДСАН. САЙТЫН БҮХ ЭРХИЙГ ХАН-УУЛ
                ДҮҮРЭГ 2-Р ХОРОО&nbsp;ЭЗЭМШИНЭ.
            </h2>
        </div>
